...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      function isEdible(pizza){
        if (pizza.containsNuts){
          //console.log(pizza.name, 'NUTTY');
          return false;
        }
        //console.log(pizza.name, 'edible?', _.every(pizza.ingredients, function(x){return x !== 'mushrooms'}) );
        return _.every(pizza.ingredients, function(x){return x !== 'mushrooms'});
      }
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    ...
    var sum = _.reduce(numArray, function(memo, num){
            if (num % 3 === 0 || num % 5 === 0) {
              return memo += num;
            }
      return memo;
